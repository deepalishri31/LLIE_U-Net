...
result_dir = '/home/21i190003/DL_Project/Sony_testresult2/'
test_img_dir = '/home/21i190003/DL_Project/Segmentation_Data/Dark_Zurich_val_anon/rgb_anon/val/night/GOPR0356/GOPR0356_frame_000330_rgb_anon.png'
# get test IDs
...
if not os.path.isdir(result_dir + 'test_zurich/'):
    os.makedirs(result_dir + 'test_zurich/')
    ...
    #for k in range(len(in_files)):
        ...
        #try:
            ...
            Image.fromarray((output * 255).astype(np.uint8),mode='RGB').save(
                result_dir +'test_zurich'+in_fn)# 'final/%5d_00_%d_out.png' % (test_id, ratio))
